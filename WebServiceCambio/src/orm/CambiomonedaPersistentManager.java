...
public class CambiomonedaPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "Cambiomoneda";
	...
	private CambiomonedaPersistentManager() throws PersistentException {
	...
	public Configuration createConfiguration() {
		...
		configuration.addAnnotatedClass(orm.Tipo_consulta.class);
		configuration.addAnnotatedClass(orm.Usuario.class);
		configuration.addAnnotatedClass(orm.Consultas.class);
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new CambiomonedaPersistentManager();
		}
